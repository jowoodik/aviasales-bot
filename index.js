...
*3. 🗺️ Составные маршруты (NEW!)*
Создайте маршрут из нескольких плечей — например, SVX → MOW → DPS → MOW → SVX. Бот проверит все комбинации дат по всем плечам и найдёт самую дешёвую связку. Для каждого плеча — свои фильтры (авиакомпания, багаж, пересадки). Можно использовать фильтры из ваших существующих маршрутов, чтобы не вводить заново.
Создать: /trip

*4. Автоматический мониторинг 24/7*
Создайте маршрут → бот проверяет его каждые 2-4 часа → присылает уведомление, когда цена упала.

*5. Умная система уведомлений*
🚨 Критические (цена < бюджет) — раз в 6ч или при падении цены
🔥 Высокие (исторический минимум) — раз в 12ч
📊 Низкие (остальное) — раз в 24ч
🌙 Ночной режим — беззвучные уведомления 23:00-08:00
